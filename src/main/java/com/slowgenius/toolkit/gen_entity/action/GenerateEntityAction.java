...
import com.slowgenius.toolkit.gen_entity.utils.TypeConverter;
...
//        List<VirtualFile> virtualFileList = ModuleRootManager.getInstance(module).getSourceRoots(JavaSourceRootType.SOURCE);
        ...
        DbTable selectDbTable = Optional.ofNullable(MyActionUtil.getDbTable(event)).orElseThrow(RuntimeException::new);
        ...
        String path = FileUtil.toSystemIndependentName(selectedPackage.getDirectories()[0].getName());
